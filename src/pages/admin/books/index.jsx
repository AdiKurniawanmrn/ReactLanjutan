...
export default function AdminBooks() {
  ...
  const getGenresName= (id) => {
    ...
    return genre ? genre.name : "unknown genres"
  }
  const getAuthorsName= (id) => {
    const author = authors.find((authors) => authors.id === id)
    return author ? author.name : "unknown authors"
  }
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                {books.length > 0 ? 
                  ...
                  <tr key = {books.id}className="border-b dark:border-gray-700">
                    ...
                    <td className="px-4 py-3">{getGenresName (books.genres_id) }</td>
                    <td className="px-4 py-3">{getAuthorsName(books.authors_id)}</td>
                    <td className="px-4 py-3 flex items-center justify-end relative">
                      <button
                        id= {`dropdown-button-${books.id}`} 
                      ...
                      >
                        ...
                        >
                          <li>
                            <Link to={`/admin/books/edit/${books.id}`}
